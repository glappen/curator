module Curator
  module Documents
    # Service object for `EmbedChunksJob`. Owns batched embedding,
    # per-input fallback on per-input errors, embedding row persistence,
    # and the document-finalization predicate.
    class EmbedChunks
